...
function enableValidation(settings) {
  ...
  //прохожу по каждой найденной форме по очереди.
  forms.forEach(form => {
    //добавляю слушатель, который следит за событием отправки формы, когда кто-то нажмёт кнопку отправки
      form.addEventListener('submit', function (evt) {
        //предотвращение стандартного поведения браузера при отправке формы
          evt.preventDefault();
