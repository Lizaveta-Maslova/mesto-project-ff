...
const avatarImage = document.querySelector('.profile__image'); //аватар пользователя
...
getInitialCards().then(userData => {
  profileName.textContent = userData.name;
  profileJob.textContent = userData.about;
  avatarImage.style.backgroundImage = `url($ХuserData.avatar)`;
})