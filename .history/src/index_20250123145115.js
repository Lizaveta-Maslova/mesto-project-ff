...
const popupTypeAvatar = document.querySelector(".popup_type_avatar"); //новая переменная для создания аватара профиля
console.log(popupTypeAvatar)
const formAvatar = document.forms["avatar"]; //находим форму по имени
