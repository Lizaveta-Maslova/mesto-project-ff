...
function enableValidation(settings) {
  ...
  forms.forEach(form => {
      form.addEventListener('submit', function (evt) {
          ...
          const aboutField = form.querySelector('.popup__input_type_description');
          const imageUrlField = form.querySelector('.popup__input_type_card-name');
          const profileValid = validateProfileForm(nameField, aboutField);
          const laceValid = validatePlaceForm(nameField, imageUrlField);
