...
// import { 
//   validateProfileForm, validatePlaceForm, enableValidation, clearValidation
...
//           evt.preventDefault();
//           const profileValid = validateProfileForm(placeInput, urlInput, profileName, profileName);
//           const placeValid = validatePlaceForm(placeInput, urlInput, profileName, profileName);
//           const isValid = profileValid && placeValid;
//           console.log(nameField)
//           if (isValid) {
//               // Отправка формы, например, с помощью метода fetch
...
function enableValidation(settings) {
  ...
  forms.forEach(form => {
      ...
      form.addEventListener('submit', function (evt) {
          ...
          if (isValid) {
              // Если форма валидна, можно отправлять, например:
      ...
      function validateInput(input) {
          ...
          const regex = `^[a-zA-Zа-яА-ЯёЁ0-9\- ]+$/`; // Регулярное выражение для валидации
