...
function handleProfileFormSubmit(res) { 
  ...
  profileTitle.textContent = res.name; //обновляет текст с именем и описанием профиля
  profileDescription.textContent = res.about; //обновляет текст описанием профиля
} 
